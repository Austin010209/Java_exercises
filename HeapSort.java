public class HeapSort 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("初始状�?�：");
        showArray(array);
        
        initHeap(array); //这个应该也是堆排序的�?部分，此处只是为了显示下结果
    ...
    {
        //建堆，从�?后一个非叶子节点�?始，而最后一个非叶子节点的下标为array.length/2-1
    ...
    public static void adjustHeap(int[] array, int count, int root)
    {
        ...
        {   //待调整子堆的根节点必须是非叶子节�?
            //�?要在root、letfchild、rightchild中找到最大的值，
            //因为�?后一个非叶子节点有可能没有右孩子，所以要做出判断�?
            if(root == count/2 - 1 && count % 2 == 0)
            {
                //节点数量为偶数时，最后一个非叶子节点只有左孩�?
